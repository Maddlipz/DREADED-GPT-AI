...
┃☘️❦│ *_𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : 𝐋𝐢𝐧𝐮𝐱_*
┃☘️❦│ *_𝐒𝐩𝐞𝐞𝐝 : 0.0009 𝐦𝐬_*
┃☘️❦│ *_𝐀𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐑𝐀𝐌 : 𝟑𝟒𝐆𝐁 𝐨𝐟 𝟔𝟐𝐆𝐁_*
┃☘️❦│ *_𝐑𝐮𝐧𝐭𝐢𝐦𝐞 : 7 𝐇𝐨𝐮𝐫𝐬, 31 𝐌𝐢𝐧𝐮𝐭𝐞𝐬, 57 𝐒𝐞𝐜𝐨𝐧𝐝𝐬_*
┃☘️❦│ *_𝐕𝐞𝐫𝐬𝐢𝐨𝐧: 𝐯𝟔.𝟎.9_*
┃☘️❦│
┃☘️❦▍▚▞▚▞▚▞▚▞▚▞▚▞▚▞▚▞▚▞│
┃☘️❦│᚜᚛᚜᚛᚜᚛᚜᚛᚜᚛᚜᚛᚜᚛᚜᚛᚜᚛᚜᚛ᚒ༒
...
if (menu === 'LINK') {
                   ...
                   client.sendMessage(m.chat, {
                        video: fs.readFileSync('./VID-20240106-WA0003.mp4'),
                        caption: cap,
                        gifPlayback: true
                    }, {
                        quoted: m
...
client.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/efd1bfa7961baf8ab6e20.jpg' }, caption: cap, fileLength: "9999999999"}, { quoted: m })
} else if (menu === 'LINK') {
client.sendMessage(m.chat, {
                        text: cap,
                        contextInfo: {
